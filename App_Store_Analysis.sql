...
-- Results ( From the analysis we get to know that the minimum rating is 0, the maximum rating is 5 and average rating is 3.52 in AppleStore.)
...
-- Checking if there is a correlation between the length of the app description and the user rating
...
-- Results ( From the analysis we get to learn that, longer the app description the better the average rating of the app.)
